...
# UI Logo Path
CROP_LOGO_PATH = Path("crop.png")

# Sample Image Path
SAMPLE_IMAGE_DIRECTORY = Path("sample_images/")
SAMPLE_IMAGE = Path(SAMPLE_IMAGE_DIRECTORY, "sample_image_00001.jpg")

# Model Paths
YOLO_MODEL_DIRECTORY = Path("models/")
YOLO_MODEL_PATH = Path(YOLO_MODEL_DIRECTORY, "yolo12x.pt")
